# Google Cybersecurity Certificate — Course 2 Completed

**Date Completed:** 16-11-2025  
**Course Title:** Play It Safe: Manage Security Risks (Course 2 of 9)  
**Modules Covered:**  
...
### Reflection
Course 2 gave me a clearer understanding of how organisations apply frameworks, controls, and structured processes to manage risk. It also introduced the practical workflow that analysts follow during incidents — including how playbooks guide consistent and effective responses.

---

### Results (screenshot)
![Course 2 Results](./screenshots/google-cybersecurity-course-2-results.png)

---

### Next Steps
- Continue progressing through the **Google Cybersecurity Certificate (Course 3 — Connect and Protect: Networks & Network Security)**  
- Proceed to **TryHackMe Pre-Security Module 4 — Linux Fundamentals**
